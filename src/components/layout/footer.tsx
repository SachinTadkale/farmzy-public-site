...
const FOOTER_LINKS = {
  Product: ["Logistics", "AI Assistant", "Credit Profiles"],
...
export default function Footer() {
  return (
    <footer className="py-12 sm:py-20 bg-background border-t border-border font-outfit">
      <Container>
        ...
        <div className="mt-12 sm:mt-20 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center text-xs text-text-secondary gap-4 text-center sm:text-left">
