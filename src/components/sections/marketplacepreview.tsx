...
export default function MarketplacePreview() {
  ...
  return (
    <SectionWrapper className="perspective-1000 overflow-hidden py-20 sm:py-32">
      ...
      <Container>
        ...
        <motion.div
          ...
          className="relative w-full aspect-video sm:aspect-video rounded-2xl sm:rounded-3xl border border-border bg-surface/50 overflow-hidden shadow-2xl dark:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)]"
        >
          {/* Dashboard UI Mock */}
          <div className="absolute inset-0 p-3 sm:p-6 md:p-8 flex flex-col">
            <div className="flex items-center justify-between mb-4 sm:mb-8">
              <div className="flex space-x-2 sm:space-x-4 items-center">
                ...
                <div className="w-20 sm:w-32 h-3 sm:h-4 bg-surface rounded-full" />
              </div>
              <div className="flex space-x-2">
                <div className="w-16 sm:w-20 h-6 sm:h-8 rounded-lg bg-surface/50 border border-border" />
            ...
            <div className="grid grid-cols-12 gap-3 sm:gap-4 flex-1">
              ...
              <div className="hidden md:block col-span-3 space-y-4">
                <div className="h-full rounded-2xl bg-surface/30 border border-border/50 p-4 space-y-4">
                  {[1, 2, 3, 4, 5].map(i => (
                    <div key={i} className="flex items-center space-x-3">
                      <div className="w-6 h-6 rounded-full bg-surface" />
                      <div className="w-full h-2 bg-surface/50 rounded-full" />
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="col-span-12 md:col-span-9 grid grid-cols-3 gap-3 sm:gap-4">
                <div className="col-span-3 sm:col-span-2 rounded-xl sm:rounded-2xl bg-surface/50 border border-border p-4 sm:p-6">
                  <div className="w-1/4 h-2 sm:h-3 bg-surface rounded-full mb-4 sm:mb-8" />
                ...
                <div className="col-span-1 hidden sm:flex flex-col space-y-4">
                  <div className="h-[calc(50%-8px)] rounded-2xl bg-surface/50 border border-border" />
                  <div className="h-[calc(50%-8px)] rounded-2xl bg-primary/5 border border-primary/10" />
                </div>
                <div className="col-span-3 h-20 sm:h-32 rounded-xl sm:rounded-2xl bg-surface/30 border border-border/50 mt-0 sm:mt-4" />
              </div>
            </div>
          </div>
